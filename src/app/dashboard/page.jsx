...
function ConditionalContent() {
  const [requestedContent, setRequestedContent] = useState(
    "a list of secret admin features"
  );
  ...
  const handleSubmit = async (e) => {
    ...
    setAiResponse(null);
    try {
      const response = await getConditionalContent({
        userRole: role,
        requestedContent,
      });
      ...
      setAiResponse({
        isAuthorized: false,
        authorizedContent: "Error fetching content from AI.",
      });
    } finally {
      setIsLoading(false);
    }
  ...
  return (
    <Card className="mt-6 bg-card/50 backdrop-blur-sm">
      <CardHeader>
        ...
        <CardDescription>
          This content is dynamically shown based on your user role, as
          determined by a GenAI model. You are currently logged in as a &quot;
          {role}&quot;.
        </CardDescription>
      </CardHeader>
      <CardContent>
            ...
            {aiResponse.isAuthorized ? (
              ...
              <div className="mt-2 text-destructive">
                ...
                <p className="mt-1 text-foreground/80">
                  The AI determined you do not have permission to view this
                  content.
                </p>
              </div>
            )}
      ...
      <div className="p-4 md:p-8">
        <Card className="shadow-lg">
          <CardHeader>
            ...
            <CardDescription>
              Your session is securely managed. You can close this tab and
